...
Feature: Feature: Load Holidays into the Accountants calendar
This isn't working yet because we still don't have recurrence rules.
...
# FixMe: This needs wiring up so that it's derived from the user
    ...
    Scenario: Create the holidays
       Given I need a set of "Holiday" annual events in the calendar named "AccountantsCal" owned by the user named "Accountant" with fields:
     | name		   	  | date       |
     | New Years                  | 2000-01-01 |
     | Epiphany                   | 2000-01-06 |
     | Assumption    		  | 2000-08-15 |
     | Michaelmus    		  | 2000-09-29 |
     | Cyprus Independence (1960) | 2000-10-01 |
